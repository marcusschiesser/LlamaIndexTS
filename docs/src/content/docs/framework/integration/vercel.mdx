...
- Use indexes (e.g. VectorStoreIndex, LlamaCloudIndex) from vectorstores in your Vercel AI applications
...
import { llamaindex } from "@vectorstores/vercel";
