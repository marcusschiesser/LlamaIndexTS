...
For OpenAI embeddings, you can use the [OpenAI](/framework/modules/embeddings/openai) instructions.


## Local Embedding

For local embeddings, you can use the [HuggingFace](/framework/modules/embeddings/huggingface) instructions.
