...
[Open in StackBlitz](https://stackblitz.com/github/run-llama/vectorstores/tree/main/examples/readers?file=src/simple-directory-reader.ts&title=Simple%20Directory%20Reader)
...
```shell 
node --import @vectorstores/readers/node ./script.js
```
