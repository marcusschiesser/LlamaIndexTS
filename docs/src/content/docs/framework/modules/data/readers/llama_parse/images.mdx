...
```package-install
npm i llamaindex llama-cloud-services @vectorstores/openai
```
...
```ts
import { Document, ImageNode, VectorStoreIndex } from "@vectorstores/core";
import { LlamaParseReader } from "llama-cloud-services";
import { OpenAI } from "@vectorstores/openai";
import { createMessageContent } from "@vectorstores/core";
...
You can see the full example file [here](https://github.com/run-llama/vectorstores/blob/main/examples/readers/src/llamaparse-json.ts).
