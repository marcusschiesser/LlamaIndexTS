...
See [reader.ts](https://github.com/marcusschiesser/vectorstores/blob/main/packages/cloud/src/reader.ts) for a list of supported file types:
...
const documents = await reader.loadData("./path/to/file.pdf");
```
