...
- [MetadataExtractor](/framework/modules/data/ingestion_pipeline/transformations/metadata_extraction)
...
```ts
import { SentenceSplitter, TitleExtractor, Document } from "@vectorstores/core";
