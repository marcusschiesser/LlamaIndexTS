...
- [ClipEmbedding](/framework-api-reference/classes/clipembedding/) using `@xenova/transformers`
- [FireworksEmbedding](/framework-api-reference/classes/fireworksembedding/) see [fireworks.ai](https://fireworks.ai/)

Check the [vectorstores Github](https://github.com/run-llama/vectorstores) for the most up to date overview of integrations.

## API Reference

- [OpenAIEmbedding](/framework-api-reference/classes/openaiembedding/)
