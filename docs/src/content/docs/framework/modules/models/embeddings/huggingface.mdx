...
To use HuggingFace embeddings, you need to import `HuggingFaceEmbedding` from `@vectorstores/huggingface`.

## Installation

```package-install
npm i llamaindex @vectorstores/huggingface
```
...
- [HuggingFaceEmbedding](/framework-api-reference/classes/huggingfaceembedding/)
