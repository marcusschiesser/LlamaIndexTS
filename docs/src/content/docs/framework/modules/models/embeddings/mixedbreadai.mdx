...
```package-install
npm i llamaindex @vectorstores/mixedbread
```
...
```ts
import { MixedbreadAIEmbeddings } from "@vectorstores/mixedbread";
import { Document, Settings } from "@vectorstores/core";
```
...
- [MixedbreadAIEmbeddings](/framework-api-reference/classes/mixedbreadaiembeddings/)
