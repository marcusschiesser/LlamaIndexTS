...
To use Azure OpenAI, you only need to install the `@vectorstores/azure` package:

## Installation

```package-install
npm i llamaindex @vectorstores/azure
```
...
See the [Azure examples](https://github.com/run-llama/vectorstores/tree/main/examples/storage/azure) for more examples of how to use Azure OpenAI.

## API Reference

- [AzureOpenAI](/framework-api-reference/classes/azureopenai/)
- [AzureOpenAIEmbedding](/framework-api-reference/classes/azureopenaiembedding/)