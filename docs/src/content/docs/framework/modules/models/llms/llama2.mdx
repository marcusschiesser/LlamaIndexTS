...
```package-install
npm i llamaindex @vectorstores/replicate
```

## Usage

```ts
import { LlamaDeuce, DeuceChatStrategy } from "@vectorstores/replicate";
...
import { LlamaDeuce, DeuceChatStrategy, ReplicateSession } from "@vectorstores/replicate";
