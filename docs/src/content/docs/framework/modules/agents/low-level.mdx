...
- Build custom agent logic in [workflow](/framework/modules/agents/workflows) steps
...
import { ChatMessage, tool } from "@vectorstores/core";
import z from "zod";
...
```ts
import { openai } from "@vectorstores/openai";
import { ChatMessage } from "@vectorstores/core";
import z from "zod";
