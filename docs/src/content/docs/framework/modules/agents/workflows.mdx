...
```package-install
npm i @vectorstores/workflow-core
```
...
In contrast, the `@vectorstores/workflow` package contains more utiltities, such as prebuilt agents.

```package-install
npm i @vectorstores/workflow
```
