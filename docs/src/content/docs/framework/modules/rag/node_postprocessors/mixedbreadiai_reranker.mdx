...
```package-install
npm i llamaindex @vectorstores/openai @vectorstores/mixedbread
```
...
import { MixedbreadAIReranker } from "@vectorstores/mixedbread";
```
...
- [MixedbreadAIReranker](/framework-api-reference/classes/mixedbreadaireranker/)
