...
```package-install
npm i llamaindex @vectorstores/cohere @vectorstores/openai
```
...
import { Node, NodeWithScore, SimilarityPostprocessor, TextNode } from "@vectorstores/core";
...
import { Node, NodeWithScore, SimilarityPostprocessor, Settings, TextNode } from "@vectorstores/core";
...
```ts
import { SimilarityPostprocessor } from "@vectorstores/core";
...
- [SimilarityPostprocessor](/framework-api-reference/classes/similaritypostprocessor/)
- [MetadataReplacementPostProcessor](/framework-api-reference/classes/metadatareplacementpostprocessor/)
