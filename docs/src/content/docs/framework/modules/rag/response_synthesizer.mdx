...
```typescript
import { NodeWithScore, TextNode, getResponseSynthesizer, responseModeSchema } from "@vectorstores/core";
...
- [Refine](/framework-api-reference/classes/refine/)
- [CompactAndRefine](/framework-api-reference/classes/compactandrefine/)
- [TreeSummarize](/framework-api-reference/classes/treesummarize/)
- [MultiModal](/framework-api-reference/classes/multimodal/)
