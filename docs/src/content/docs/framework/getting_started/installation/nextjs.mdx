...
description: Deploy vectorstores in Next.js applications with API routes, server components, and edge runtime.
---

This guide covers integrating vectorstores agents with Next.js applications.
...
- Explore [server APIs](/framework/getting_started/installation/server-apis)
