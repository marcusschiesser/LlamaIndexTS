...
Make sure you have installed vectorstores and have an OpenAI key. If you haven't, check out the [installation](/framework/getting_started/installation) guide.

You can use [other LLMs](/framework/modules/models/llms) via their APIs; if you would prefer to use local models check out our [local LLM example](/framework/tutorials/local_llm).
...
npm init
npm i -D typescript @types/node
npm i @vectorstores/anthropic zod@3.25.76
```
