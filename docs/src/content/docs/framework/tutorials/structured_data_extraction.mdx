...
Make sure you have installed vectorstores and have an OpenAI key. If you haven't, check out the [installation](/typescript/framework/getting_started/installation) guide.
