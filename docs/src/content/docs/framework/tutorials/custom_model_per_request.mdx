...
import { OpenAIEmbedding } from '@vectorstores/embeddings-openai';
...
The full example can be found [here](https://github.com/run-llama/vectorstores/tree/main/examples/local-settings).